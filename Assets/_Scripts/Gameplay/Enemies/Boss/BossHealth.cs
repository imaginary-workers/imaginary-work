...
namespace Game.Gameplay.Enemies.Boss
{
    public class BossHealth : MonoBehaviour, IDamageable
    {
        ...
        [SerializeField, Range(0, 10000)] int _maxHealth;
        [SerializeField, Range(0, 10000)] int _endPhase1;
        [SerializeField, Range(0, 10000)] int _endPhase2;
        [SerializeField, Range(0, 500)] int amountToWeakBeforeEndPhase;
